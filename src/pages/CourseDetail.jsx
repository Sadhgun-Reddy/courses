      ...
      <div className="cd-sidebar-inner">
        <div className="cd-sidebar-meta">
          {[
            ...
            { icon: '📊', label: 'Level', value: (course.courseLevel || 'All levels').toLowerCase().split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ') },
        ...
        <div className="cd-sidebar-ctas">
          <a href={`https://wa.me/919010016664?text=Hi%20VOLTEDZ%2C%20I%20am%20interested%20in%20the%20${course.title}%20course.`} target="_blank" rel="noopener noreferrer" className="cd-cta-whatsapp">
